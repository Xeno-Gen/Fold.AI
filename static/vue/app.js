...
Component that was made reactive: `,
  ...
  var decorate$1 = (t3) => {
    t3.displayName = "Transition";
    t3.props = TransitionPropsValidators;
    return t3;
  };
          ...
          <div class="input-wrapper-outer">
              ...
              <div class="input-toolbar">
                  <div class="toolbar-left">
                      ...
                      <button class="tool-btn" id="initialSettingsBtn" @click="openDrawer"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="3"/><path d="M19.4 15a1.65 1.65 0 0 0 .33 1.82l.06.06a2 2 0 0 1-2.83 2.83l-.06-.06a1.65 1.65 0 0 0-1.82-.33 1.65 1.65 0 0 0-1 1.51V21a2 2 0 0 1-4 0v-.09A1.65 1.65 0 0 0 9 19.4a1.65 1.65 0 0 0-1.82.33l-.06.06a2 2 0 0 1-2.83-2.83l.06-.06A1.65 1.65 0 0 0 4.68 15a1.65 1.65 0 0 0-1.51-1H3a2 2 0 0 1 0-4h.09A1.65 1.65 0 0 0 4.6 9a1.65 1.65 0 0 0-.33-1.82l-.06-.06a2 2 0 0 1 2.83-2.83l.06.06A1.65 1.65 0 0 0 9 4.68a1.65 1.65 0 0 0 1-1.51V3a2 2 0 0 1 4 0v.09a1.65 1.65 0 0 0 1 1.51 1.65 1.65 0 0 0 1.82-.33l.06-.06a2 2 0 0 1 2.83 2.83l-.06.06A1.65 1.65 0 0 0 19.4 9a1.65 1.65 0 0 0 1.51 1H21a2 2 0 0 1 0 4h-.09a1.65 1.65 0 0 0-1.51 1z"/></svg></button>
          ...
          <div class="input-wrapper-outer">
              ...
              <div class="input-toolbar">
                  <div class="toolbar-left">
                      ...
                      <button class="tool-btn" id="settingsBtn" @click="openDrawer"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="3"/><path d="M19.4 15a1.65 1.65 0 0 0 .33 1.82l.06.06a2 2 0 0 1-2.83 2.83l-.06-.06a1.65 1.65 0 0 0-1.82-.33 1.65 1.65 0 0 0-1 1.51V21a2 2 0 0 1-4 0v-.09A1.65 1.65 0 0 0 9 19.4a1.65 1.65 0 0 0-1.82.33l-.06.06a2 2 0 0 1-2.83-2.83l.06-.06A1.65 1.65 0 0 0 4.68 15a1.65 1.65 0 0 0-1.51-1H3a2 2 0 0 1 0-4h.09A1.65 1.65 0 0 0 4.6 9a1.65 1.65 0 0 0-.33-1.82l-.06-.06a2 2 0 0 1 2.83-2.83l.06.06A1.65 1.65 0 0 0 9 4.68a1.65 1.65 0 0 0 1-1.51V3a2 2 0 0 1 4 0v.09a1.65 1.65 0 0 0 1 1.51 1.65 1.65 0 0 0 1.82-.33l.06-.06a2 2 0 0 1 2.83 2.83l-.06.06A1.65 1.65 0 0 0 19.4 9a1.65 1.65 0 0 0 1.51 1H21a2 2 0 0 1 0 4h-.09a1.65 1.65 0 0 0-1.51 1z"/></svg></button>
...
`;
  ...
  var chatTitles = ref([]);
  var chatTokens = ref([]);
  var currentChat = ref(-1);
  var chatBranches = ref({});
  var pinnedChats = ref(/* @__PURE__ */ new Set());
  var pendingNewChatIndex = ref(null);
  var isChatActive = ref(false);
  var streaming = ref(false);
  var isUserScrolledAway = ref(false);
  var currentAbortController = ref(null);
  var currentRequestId = ref(null);
  var lastScrollTop2 = ref(0);
  var cachedMemories = ref([]);
  var currentProvider = ref(null);
  var currentChatFormat = ref("OpenAI");
  var currentModel = ref("deepseek-v4-flash");
  var providers = ref([]);
  var availableModels = ref([]);
  var allModels = ref([]);
  var currentParams = reactive({
    temperature: 0.7,
    top_p: 1,
    max_tokens: 2048,
    seed: null,
  ...
  var customPort = ref(8080);
  var pureMode = ref(false);
  var promptLang = ref("zh");
  var baseSystemPrompt = ref("");
  var baseSystemTokenCount = ref(0);
  var pluginPrompts = ref({});
  var maxContextTokens = ref(1e6);
  var currentTheme = ref("system");
  var deepThinkEnabled = ref(false);
  var currentThinkMode = ref("fast");
  var cothinkEnabled = ref(true);
  var autoCollapseThink = ref(true);
  var thinkCollapseDuring = ref("off");
  var streamAnimation = ref("none");
  var includeReasoning = ref(true);
  var chatFontSize = ref(15);
  var streamEnabled = ref(true);
  var commandExecEnabled = ref(false);
  var commandConfirmEnabled = ref(true);
  var sandboxEnabled = ref(true);
  var compressOldExecutions = ref(true);
  var collapsePluginOutput = ref(true);
  var memoryEnabled = ref(true);
  var agentEnabled = ref(false);
  var agentMaxIterations = ref(10);
  var askEnabled = ref(true);
  var askAutoShow = ref(true);
  var activeFiles = reactive({ initial: [], chat: [] });
  var filesCurrentDir = ref("/");
  var defaultWorkDir = ref("");
  var showSettings = ref(false);
  var showSettingsModal = ref(false);
  var showFileBrowser = ref(false);
  var showFileViewer = ref(false);
  var fileViewerData = reactive({ name: "", content: "" });
  var showDeepThinkPopup = ref(false);
  var showSlashPopup = ref(false);
  var showAskPopup = ref(false);
  var showDrawer = ref(false);
  var activeSettingsTab = ref("preferences");
  var currentMessages = computed2(() => chats.value[currentChat.value] || []);
  var currentChatTitle = computed2(() => chatTitles.value[currentChat.value] || "");
  var currentChatToken = computed2(() => chatTokens.value[currentChat.value] || "");
  var currentChatBranch = computed2(() => chatBranches.value[currentChat.value] || {});

  // static/vue/composables/useI18n.ts
  ...
  var currentLang = ref(getInitialLang());
  function useI18n() {
    function t3(key) {
    ...
    return { t: t3, setLang, getLang, currentLang };
  }

  // static/vue/composables/useTheme.ts
  function useTheme() {
    function applyTheme(theme) {
      const t3 = theme || currentTheme.value;
      let resolved;
      if (t3 === "system") {
    ...
    const saved = localStorage.getItem("fold_ai_theme");
    if (saved) {
  ...
  // static/vue/composables/useStreaming.ts
  function useStreaming() {
    const fullContent = shallowRef("");
    const fullReasoning = shallowRef("");
    const streamUsage = ref(null);
    const streamError = ref(null);
    async function processStream2(reader, callbacks) {
    ...
    return { fullContent, fullReasoning, streamUsage, streamError, processStream: processStream2, reset: reset2 };
  }

  // static/vue/composables/useHistory.ts
  var { t } = useI18n();
  function useHistory() {
    ...
    async function saveChatToBackend2(chatId) {
    ...
    async function newChatOnServer2() {
      try {
    ...
    return { loadChatsFromBackend, saveChatToBackend: saveChatToBackend2, newChatOnServer: newChatOnServer2, deleteChatFromBackend };
  }

  // static/vue/composables/useChat.ts
  var { t: t2 } = useI18n();
  var { processStream, reset: resetStream } = useStreaming();
  var { saveChatToBackend, newChatOnServer } = useHistory();
  ...
  function useChat() {
    const streamingMsgIndex = ref(null);
    const streamingContent = ref("");
    const streamingReasoning = ref("");
    function stripTags(text) {
      return text.replace(/<mem:[^>]+>[\s\S]*?<\/mem>/gi, "").replace(/<power>[\s\S]*?<\/power>/gi, "").replace(/<powershell>[\s\S]*?<\/powershell>/gi, "").replace(/<cmd>[\s\S]*?<\/cmd>/gi, "").replace(/<shell>[\s\S]*?<\/shell>/gi, "").replace(/<mem-del:[^>]+>/gi, "").trim();
    }
    function buildToolPrompt() {
      let text = "";
      if (pluginPrompts.value) {
        if (pluginPrompts.value.plugins) {
          for (const p2 of pluginPrompts.value.plugins) {
            if (p2.prompt) text += p2.prompt + "\n";
          }
        }
      }
      return text;
    ...
    async function callAPI(messages) {
      if (!currentModel.value) throw new Error(t2("noModel"));
    ...
    async function sendMessage(userText = "", target = "initial") {
      if (streaming.value) {
        console.log("[Chat] already streaming");
        return;
      }
      ...
      const imgs = imageFiles.map((f) => f.content);
      const userMsg = { role: "user", content: userText || "", images: imgs };
        ...
        for (let agentIter = 0; agentIter < maxAgentIter; agentIter++) {
          let iterMsgs = reorderMessages(
            compressOldExecMessages(
              chats.value[currentChat.value].filter((m) => m.role).map((m) => {
                const msg = { role: m.role, content: m.content, images: m.images || [], _isExec: m._isExec };
                if (m.role === "assistant" && includeReasoning.value && m.reasoning) {
                  msg.reasoning = m.reasoning.length > 2e3 ? m.reasoning.substring(0, 2e3) + "..." : m.reasoning;
                }
                return msg;
              })
            )
          ...
          if (toolPromptText) {
            const hasToolPrompt = iterMsgs.some(
              (m) => m.role === "system" && (m.content.includes("[Agent") || m.content.includes("[\u5DE5\u5177"))
            );
            if (!hasToolPrompt) {
            ...
            try {
              ...
              if (cfgRes.ok) {
                ...
                if (cfg.think && cfg.think.trim()) {
                  const exists = iterMsgs.some((m) => m.role === "system" && m.content.includes(cfg.think.substring(0, 20)));
          ...
          if (cothinkEnabled.value && pluginPrompts.value?.cothink) {
            const exists = iterMsgs.some((m) => m.role === "system" && m.content.includes("[\u601D\u7EF4\u94FE"));
            if (!exists) {
          ...
          let sysCount = iterMsgs.filter((m) => m.role === "system").length;
          ...
          if (memoryEnabled.value && cachedMemories.value.length > 0) {
            let memContent = "[\u5DF2\u6709\u8BB0\u5FC6]\n";
            cachedMemories.value.forEach((m, i) => {
              memContent += "\n" + (i + 1) + ". " + m.key + ": " + (m.content || "");
            });
            sysCount = iterMsgs.filter((m) => m.role === "system").length;
      ...
      saveChatToBackend();
      if (chatTitles.value[currentChat.value] === t2("currentChatTitle") || chatTitles.value[currentChat.value] === "\u65B0\u5BF9\u8BDD") {
        const firstUserMsg = chats.value[currentChat.value].find((m) => m.role === "user");
    ...
    async function processToolCalls(responseText) {
      ...
      for (const cmd of commands) {
        if (dangerousPatterns.some((p2) => p2.test(cmd.command))) {
  ...
  // static/vue/composables/useSettings.ts
  function useSettings() {
    function loadSettingsFromLocal() {
      try {
        ...
        if (s.thinkMode) {
          currentThinkMode.value = s.thinkMode;
          deepThinkEnabled.value = s.thinkMode !== "fast";
        }
        if (s.autoCollapse !== void 0) autoCollapseThink.value = s.autoCollapse;
        if (s.thinkCollapse) thinkCollapseDuring.value = s.thinkCollapse;
        if (s.streamAnimation) streamAnimation.value = s.streamAnimation;
        if (s.includeReasoning !== void 0) includeReasoning.value = s.includeReasoning;
        if (s.fontSize) chatFontSize.value = s.fontSize;
        if (s.streamEnabled !== void 0) streamEnabled.value = s.streamEnabled;
        if (s.commandConfirm !== void 0) commandConfirmEnabled.value = s.commandConfirm;
        if (s.compressExec !== void 0) compressOldExecutions.value = s.compressExec;
        if (s.collapsePlugin !== void 0) collapsePluginOutput.value = s.collapsePlugin;
        if (s.agentEnabled !== void 0) agentEnabled.value = s.agentEnabled;
        if (s.agentMaxIterations) agentMaxIterations.value = s.agentMaxIterations;
        if (s.commandExecEnabled !== void 0) commandExecEnabled.value = s.commandExecEnabled;
        if (s.memoryEnabled !== void 0) memoryEnabled.value = s.memoryEnabled;
        if (s.askEnabled !== void 0) askEnabled.value = s.askEnabled;
        if (s.askAutoShow !== void 0) askAutoShow.value = s.askAutoShow;
        if (s.cothinkEnabled !== void 0) cothinkEnabled.value = s.cothinkEnabled;
        if (s.sandboxEnabled !== void 0) sandboxEnabled.value = s.sandboxEnabled;
      } catch {
      }
    }
    ...
    watch2(
      [
        ...
        chatFontSize,
        streamEnabled,
        commandConfirmEnabled,
        compressOldExecutions,
        collapsePluginOutput,
        agentEnabled,
        agentMaxIterations,
        commandExecEnabled,
        memoryEnabled,
  ...
  // static/vue/components/message-bubble.ts
  ...
  function renderAIContent(text) {
    if (!text) return "";
    let html = text.replace(/<power>([\s\S]*?)<\/power>/g, '<div class="plugin-block plugin-power"><div class="plugin-block-header">\u26A1 $1</div></div>').replace(/<cmd>([\s\S]*?)<\/cmd>/g, '<div class="plugin-block plugin-cmd"><div class="plugin-block-header">\u{1F4BB} $1</div></div>').replace(/<mem>([\s\S]*?)<\/mem>/g, '<div class="plugin-block plugin-mem"><div class="plugin-block-header">\u{1F4DD} $1</div></div>').replace(/<ask[^>]*>([\s\S]*?)<\/ask>/g, '<div class="plugin-block plugin-ask"><div class="plugin-block-header">\u2753 $1</div></div>');
    try {
  ...
  var MessageBubble = defineComponent({
    name: "MessageBubble",
    props: {
  ...
  `,
    setup(props, { emit: emit2 }) {
      const { t: t3 } = useI18n();
      const bubbleClass = computed2(() => "message-" + props.message.role);
      const renderedContent = computed2(() => renderMarkdown(props.message.content || ""));
      const aiContent = computed2(() => renderAIContent(props.message.content || ""));
      const renderedReasoning = computed2(() => renderMarkdown(props.message.reasoning || ""));
      const actions = computed2(() => {
        const acts = [];
        ...
        if (msg.role === "assistant") {
          acts.push({
            ...
            handler: () => emit2("regenerate", idx)
          });
        }
        return acts;
      });
      const editing = computed2(() => false);
      const editText = computed2(() => "");
      function saveEdit() {
      }
      function cancelEdit() {
      }
      return { t: t3, bubbleClass, renderedContent, aiContent, renderedReasoning, actions, editing, editText, saveEdit, cancelEdit };
    }
  });

  // static/vue/components/deep-think-popup.ts
  var DeepThinkPopup = defineComponent({
    name: "DeepThinkPopup",
    props: {
  ...
  `,
    setup(props, { emit: emit2 }) {
      ...
      function selectMode(mode) {
        ...
        emit2("select-mode", mode);
        emit2("close");
      }
      function delayedClose() {
        setTimeout(() => emit2("close"), 200);
      }
      return { t: t3, tools, thinkModes, currentThinkMode, selectMode, delayedClose };
    }
  });

  // static/vue/components/model-picker.ts
  var ModelPicker = defineComponent({
    name: "ModelPicker",
    props: {
      show: { type: Boolean, default: false },
      style: { type: Object, default: () => ({}) }
  ...
  `,
    setup(props, { emit: emit2 }) {
      ...
      const filteredModels = computed2(() => {
        if (!search.value) return allModels.value;
        return allModels.value.filter((m) => m.toLowerCase().includes(search.value.toLowerCase()));
      });
      ...
      return { t: t3, search, filteredModels, currentModel, selectedIndex, selectModel, onKeydown };
    }
  });
  ...
  var MainApp = {
    ...
    setup() {
      const { t: t3, setLang, currentLang: currentLang2 } = useI18n();
      ...
      const { saveChatToBackend: saveChatToBackend2, loadChatsFromBackend } = useHistory();
      useSettings();
      ...
      const langText = computed2(() => currentLang2.value === "zh" ? "English" : "\u4E2D\u6587");
      const settingsTabs = [
      ...
      const filteredModels = computed2(() => {
        ...
        return allModels.value.filter((m) => m.toLowerCase().includes(modelSearch.value.toLowerCase()));
      });
      ...
      function newChat() {
        chats.value.push([]);
        chatTitles.value.push(t3("currentChatTitle"));
      ...
      function sendFromInitial() {
        ...
        sendChatMessage(text, "initial").catch((e) => showToast("\u9519\u8BEF: " + e.message));
        initialInput.value = "";
      }
      function sendFromChat() {
        const text = chatInput.value.trim();
        if (!text && activeFiles.chat.length === 0) return;
        sendChatMessage(text, "chat").catch((e) => showToast("\u9519\u8BEF: " + e.message));
        chatInput.value = "";
      }
      function stopGeneration() {
        stopChatGeneration();
      ...
      function onSelectThinkMode(mode) {
        currentThinkMode.value = mode;
        deepThinkEnabled.value = mode !== "fast";
        ...
        for (const file of Array.from(input.files)) {
          try {
            ...
            if (r.ok) {
              ...
              activeFiles[fileInputTarget].push(data);
            }
          } catch (err) {
            showToast(t3("uploadFailed"));
          }
        }
        input.value = "";
      }
      function removeFile(target, index) {
        activeFiles[target].splice(index, 1);
      }
      function toggleDeepThinkPopup(e) {
      ...
      function onModelSearchKeydown(e) {
        if (e.key === "ArrowDown") {
          e.preventDefault();
          modelPickerIndex.value = Math.min(modelPickerIndex.value + 1, filteredModels.value.length - 1);
        } else if (e.key === "ArrowUp") {
          e.preventDefault();
          modelPickerIndex.value = Math.max(modelPickerIndex.value - 1, 0);
        } else if (e.key === "Enter" && filteredModels.value[modelPickerIndex.value]) {
          selectModel(filteredModels.value[modelPickerIndex.value]);
        } else if (e.key === "Escape") {
          showModelPicker.value = false;
        }
      }
      ...
      async function loadIdentity() {
        try {
          ...
          if (r.ok) {
            const d = await r.json();
            userIdentity.value = d.id || d.userId || "";
          }
        } catch {
        }
      }
      ...
      async function loadDirectory(dir) {
        ...
        try {
          const wd = workDirInput.value || defaultWorkDir.value || void 0;
      ...
      function refreshFiles() {
        loadDirectory(filesCurrentDir.value);
      }
      ...
      async function viewFile(item) {
        ...
        try {
          ...
          if (r.ok) {
            ...
            fileViewerContent.value = data.text ? '<pre style="padding:16px;font-size:13px;white-space:pre-wrap;word-break:break-word;">' + escapeHtml2(data.content) + "</pre>" : '<img src="' + data.image + '" style="max-width:100%;">';
      ...
      function copyMessage(content) {
        navigator.clipboard.writeText(content).then(() => showToast(t3("copied")));
      }
      ...
      function toggleThinkCollapse(idx) {
      ...
      function renderAIContent2(text) {
        if (!text) return "";
        let html = text.replace(/<power>([\s\S]*?)<\/power>/g, '<div class="plugin-block plugin-power"><div class="plugin-block-header">\u26A1 $1</div></div>').replace(/<cmd>([\s\S]*?)<\/cmd>/g, '<div class="plugin-block plugin-cmd"><div class="plugin-block-header">\u{1F4BB} $1</div></div>').replace(/<mem>([\s\S]*?)<\/mem>/g, '<div class="plugin-block plugin-mem"><div class="plugin-block-header">\u{1F4DD} $1</div></div>').replace(/<ask[^>]*>([\s\S]*?)<\/ask>/g, '<div class="plugin-block plugin-ask"><div class="plugin-block-header">\u2753 $1</div></div>');
        try {
          return marked.parse(html, { breaks: true });
      ...
      async function loadAllFromBackend() {
        try {
          ...
          if (configR.ok) {
            ...
            if (config.systemPrompt !== void 0) currentParams.systemPrompt = config.systemPrompt;
            if (config.chatFormat) currentChatFormat.value = config.chatFormat;
            if (config.pureMode !== void 0) pureMode.value = config.pureMode;
      ...
      watch2([currentProvider, currentModel], () => {
        saveConfigToBackend();
      });
      watch2(currentProvider, () => {
        refreshKeyList();
        if (currentProvider.value) loadModels(currentProvider.value);
      });
      function toggleLang() {
        setLang(currentLang2.value === "zh" ? "en" : "zh");
      }
      onMounted(async () => {
      ...
      return {
        ...
        renderAIContent: renderAIContent2,
        onChatScroll,
        updateHistoryList,
        triggerFileInput,
        onFileSelected,
